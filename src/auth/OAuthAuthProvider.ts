...
import { DefaultClient } from "../api/resources/auth/resources/default/client/Client";
...
export class OAuthAuthProvider implements core.AuthProvider {
    ...
    private readonly authClient: DefaultClient;
    ...
    constructor(options: OAuthAuthProvider.Options & OAuthAuthProvider.ClientCredentials) {
        ...
        this.authClient = new DefaultClient(options);
    ...
    private async refresh({ endpointMetadata }: { endpointMetadata?: core.EndpointMetadata } = {}): Promise<string> {
        this.refreshPromise = (async () => {
            try {
                ...
                this.accessToken = tokenResponse.body.accessToken;
                this.expiresAt = this.getExpiresAt(tokenResponse.body.expiresIn, BUFFER_IN_MINUTES);
                return this.accessToken;
            } finally {

...
export const RenderingProviderUpdate: core.serialization.ObjectSchema<
    serializers.encounterProviders.v2.RenderingProviderUpdate.Raw,
    CandidApi.encounterProviders.v2.RenderingProviderUpdate
> = core.serialization
    .object({

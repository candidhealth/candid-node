...
export const FacilityCredentialingSpanCreate: core.serialization.Schema<
    serializers.credentialing.v2.FacilityCredentialingSpanCreate.Raw,
    CandidApi.credentialing.v2.FacilityCredentialingSpanCreate
...
export declare namespace FacilityCredentialingSpanCreate {

...
export const Error: core.serialization.Schema<
    serializers.thirdPartyPayerRefunds.v1.getMulti.Error.Raw,
...
> = core.serialization
    ...
    .transform<CandidApi.thirdPartyPayerRefunds.v1.getMulti.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "UnprocessableEntityError":
                    return CandidApi.thirdPartyPayerRefunds.v1.getMulti.Error.unprocessableEntityError(value.content);
            }
        },

...
export const Error: core.serialization.Schema<
    serializers.preEncounter.patientMerges.v1.search.Error.Raw,
...
> = core.serialization
    ...
    .transform<CandidApi.preEncounter.patientMerges.v1.search.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "BadRequestError":
                    return CandidApi.preEncounter.patientMerges.v1.search.Error.badRequestError(value.content);
            }
        },

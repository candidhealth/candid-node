...
export const Error: core.serialization.Schema<
    serializers.preEncounter.appointments.v1.getCounts.Error.Raw,
...
> = core.serialization
    ...
    .transform<CandidApi.preEncounter.appointments.v1.getCounts.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "BadRequestError":
                    return CandidApi.preEncounter.appointments.v1.getCounts.Error.badRequestError(value.content);
            }
        },

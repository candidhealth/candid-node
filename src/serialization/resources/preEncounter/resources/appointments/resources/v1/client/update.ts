...
export const Error: core.serialization.Schema<
    serializers.preEncounter.appointments.v1.update.Error.Raw,
...
> = core.serialization
    ...
    .transform<CandidApi.preEncounter.appointments.v1.update.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "NotFoundError":
                    return CandidApi.preEncounter.appointments.v1.update.Error.notFoundError(value.content);
                case "VersionConflictError":
                    return CandidApi.preEncounter.appointments.v1.update.Error.versionConflictError(value.content);
            }
        },

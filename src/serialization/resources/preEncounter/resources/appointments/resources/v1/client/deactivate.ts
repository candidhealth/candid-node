...
export const Error: core.serialization.Schema<
    serializers.preEncounter.appointments.v1.deactivate.Error.Raw,
    CandidApi.preEncounter.appointments.v1.deactivate.Error
> = core.serialization
    .union("errorName", {
    ...
    .transform<CandidApi.preEncounter.appointments.v1.deactivate.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "NotFoundError":
                    return CandidApi.preEncounter.appointments.v1.deactivate.Error.notFoundError(value.content);
                case "VersionConflictError":
                    return CandidApi.preEncounter.appointments.v1.deactivate.Error.versionConflictError(value.content);
            }
        },

...
export const Error: core.serialization.Schema<
    serializers.preEncounter.patients.v1.createNoDuplicateCheck.Error.Raw,
...
> = core.serialization
    ...
    .transform<CandidApi.preEncounter.patients.v1.createNoDuplicateCheck.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "VersionConflictError":
                    return CandidApi.preEncounter.patients.v1.createNoDuplicateCheck.Error.versionConflictError(
                        value.content
                    );
            }
        },

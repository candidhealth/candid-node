...
export const Error: core.serialization.Schema<
    serializers.preEncounter.patients.v1.patients.deactivate.Error.Raw,
    CandidApi.preEncounter.patients.v1.patients.deactivate.Error
> = core.serialization
    .union("errorName", {
    ...
    .transform<CandidApi.preEncounter.patients.v1.patients.deactivate.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "NotFoundError":
                    return CandidApi.preEncounter.patients.v1.patients.deactivate.Error.notFoundError(value.content);
                case "VersionConflictError":
                    return CandidApi.preEncounter.patients.v1.patients.deactivate.Error.versionConflictError(
                        value.content
                    );
            }
        },

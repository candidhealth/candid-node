...
export const Response: core.serialization.Schema<
    serializers.preEncounter.patients.getHistory.Response.Raw,
...
export const Error: core.serialization.Schema<
    serializers.preEncounter.patients.getHistory.Error.Raw,
    CandidApi.preEncounter.patients.getHistory.Error
> = core.serialization
    .union("errorName", {
    ...
    .transform<CandidApi.preEncounter.patients.getHistory.Error>({
        transform: (value) => {

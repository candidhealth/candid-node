...
export const Error: core.serialization.Schema<
    serializers.preEncounter.coverages.v1.coverages.update.Error.Raw,
...
> = core.serialization
    ...
    .transform<CandidApi.preEncounter.coverages.v1.coverages.update.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "NotFoundError":
                    return CandidApi.preEncounter.coverages.v1.coverages.update.Error.notFoundError(value.content);
                case "VersionConflictError":
                    return CandidApi.preEncounter.coverages.v1.coverages.update.Error.versionConflictError(
                        value.content
                    );
            }
        },

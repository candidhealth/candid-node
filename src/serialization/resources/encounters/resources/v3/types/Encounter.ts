...
export const Encounter: core.serialization.ObjectSchema<
    serializers.encounters.v3.Encounter.Raw,
    CandidApi.encounters.v3.Encounter
> = core.serialization
    .object({
        ...
        clinicalNotes: core.serialization.property(
            ...
            core.serialization.list(
                core.serialization.lazyObject(
                    async () => (await import("../../../../..")).encounters.v3.ClinicalNoteCategory
                )
            )
        ),
        ...
        codingAttribution: core.serialization.property(
            "coding_attribution",
            core.serialization
                .lazy(async () => (await import("../../../../..")).encounters.v3.CodingAttributionType)
                .optional()
        ),
    })
...
export declare namespace Encounter {
    interface Raw extends serializers.encounters.v3.EncounterBase.Raw {
        ...
        clinical_notes: serializers.encounters.v3.ClinicalNoteCategory.Raw[];
        ...
        patient_histories: serializers.encounters.v3.PatientHistoryCategory.Raw[];
        patient_payments: serializers.patientPayments.v2.PatientPayment.Raw[];
        tags: serializers.Tag.Raw[];
        coding_attribution?: serializers.encounters.v3.CodingAttributionType.Raw | null;
    }
}

...
export const Error: core.serialization.Schema<
    serializers.encounters.v4.createFromPreEncounterPatientUniversal.Error.Raw,
...
> = core.serialization
    ...
    .transform<CandidApi.encounters.v4.createFromPreEncounterPatientUniversal.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "EncounterExternalIdUniquenessError":
                    return CandidApi.encounters.v4.createFromPreEncounterPatientUniversal.Error.encounterExternalIdUniquenessError(
                        value.content,
                    );
                case "EncounterPatientControlNumberUniquenessError":
                    return CandidApi.encounters.v4.createFromPreEncounterPatientUniversal.Error.encounterPatientControlNumberUniquenessError(
                        value.content,
                    );
                case "EntityNotFoundError":
                    return CandidApi.encounters.v4.createFromPreEncounterPatientUniversal.Error.entityNotFoundError(
                        value.content,
                    );
                case "UnauthorizedError":
                    return CandidApi.encounters.v4.createFromPreEncounterPatientUniversal.Error.unauthorizedError(
                        value.content,
                    );
                case "HttpRequestValidationsError":
                    return CandidApi.encounters.v4.createFromPreEncounterPatientUniversal.Error.httpRequestValidationsError(
                        value.content,
                    );
                case "SchemaInstanceValidationHttpFailure":
                    return CandidApi.encounters.v4.createFromPreEncounterPatientUniversal.Error.schemaInstanceValidationHttpFailure(
                        value.content,
                    );
                case "UnprocessableEntityError":
                    return CandidApi.encounters.v4.createFromPreEncounterPatientUniversal.Error.unprocessableEntityError(
                        value.content,
                    );
                case "HttpRequestValidationError":
                    return CandidApi.encounters.v4.createFromPreEncounterPatientUniversal.Error.httpRequestValidationError(
                        value.content,
                    );
                case "PayerPlanGroupPayerDoesNotMatchInsuranceCardHttpError":
                    return CandidApi.encounters.v4.createFromPreEncounterPatientUniversal.Error.payerPlanGroupPayerDoesNotMatchInsuranceCardHttpError(
                        value.content,
                    );
            }
        },

...
export const Error: core.serialization.Schema<
    serializers.encounters.v4.createFromPreEncounterPatientInternal.Error.Raw,
    CandidApi.encounters.v4.createFromPreEncounterPatientInternal.Error
> = core.serialization
    .union("errorName", {
    ...
    .transform<CandidApi.encounters.v4.createFromPreEncounterPatientInternal.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "EncounterExternalIdUniquenessError":
                    return CandidApi.encounters.v4.createFromPreEncounterPatientInternal.Error.encounterExternalIdUniquenessError(
                        value.content
                    );
                case "EncounterPatientControlNumberUniquenessError":
                    return CandidApi.encounters.v4.createFromPreEncounterPatientInternal.Error.encounterPatientControlNumberUniquenessError(
                        value.content
                    );
                case "EntityNotFoundError":
                    return CandidApi.encounters.v4.createFromPreEncounterPatientInternal.Error.entityNotFoundError(
                        value.content
                    );
                case "HttpRequestValidationsError":
                    return CandidApi.encounters.v4.createFromPreEncounterPatientInternal.Error.httpRequestValidationsError(
                        value.content
                    );
                case "SchemaInstanceValidationHttpFailure":
                    return CandidApi.encounters.v4.createFromPreEncounterPatientInternal.Error.schemaInstanceValidationHttpFailure(
                        value.content
                    );
                case "HttpRequestValidationError":
                    return CandidApi.encounters.v4.createFromPreEncounterPatientInternal.Error.httpRequestValidationError(
                        value.content
                    );
            }
        },

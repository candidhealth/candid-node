...
export const Error: core.serialization.Schema<
    serializers.encounters.v4.updateUniversal.Error.Raw,
    CandidApi.encounters.v4.updateUniversal.Error
> = core.serialization
    .union("errorName", {
    ...
    .transform<CandidApi.encounters.v4.updateUniversal.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "EncounterExternalIdUniquenessError":
                    return CandidApi.encounters.v4.updateUniversal.Error.encounterExternalIdUniquenessError(
                        value.content,
                    );
                ...
                case "SchemaInstanceValidationHttpFailure":
                    return CandidApi.encounters.v4.updateUniversal.Error.schemaInstanceValidationHttpFailure(
                        value.content,
                    );
                ...
                case "PayerPlanGroupPayerDoesNotMatchInsuranceCardHttpError":
                    return CandidApi.encounters.v4.updateUniversal.Error.payerPlanGroupPayerDoesNotMatchInsuranceCardHttpError(
                        value.content,
                    );
            }
        },

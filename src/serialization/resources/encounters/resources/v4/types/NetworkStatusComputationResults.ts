...
export const NetworkStatusComputationResults: core.serialization.ObjectSchema<
    serializers.encounters.v4.NetworkStatusComputationResults.Raw,
...
> = core.serialization.object({
    contractingStatusResult: core.serialization.property(
        ...
        core.serialization.lazy(
            async () => (await import("../../../../..")).encounters.v4.AttributableContractingStatusResult
        )
    ),
    ...
    networkStatus: core.serialization.property(
        "network_status",
        core.serialization.lazy(async () => (await import("../../../../..")).encounters.v4.NetworkStatus)
    ),
});

export declare namespace NetworkStatusComputationResults {
    interface Raw {
        contracting_status_result: serializers.encounters.v4.AttributableContractingStatusResult.Raw;
        credentialing_status_result: serializers.EncounterCredentialingStatusResult.Raw;
        network_status: serializers.encounters.v4.NetworkStatus.Raw;
    }
}

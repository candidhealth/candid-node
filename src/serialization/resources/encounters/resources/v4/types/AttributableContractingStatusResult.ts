...
export const AttributableContractingStatusResult: core.serialization.Schema<
    serializers.encounters.v4.AttributableContractingStatusResult.Raw,
    CandidApi.encounters.v4.AttributableContractingStatusResult
> = core.serialization
    .union(core.serialization.discriminant("contractingStatus", "contracting_status"), {
        out_of_network: core.serialization.lazyObject(
            async () => (await import("../../../../..")).encounters.v4.OutOfNetworkContractingStatusResult
        ),
        in_network: core.serialization.lazyObject(
            async () => (await import("../../../../..")).encounters.v4.InNetworkContractingStatusResult
        ),
        unknown: core.serialization.object({}),
    })
    .transform<CandidApi.encounters.v4.AttributableContractingStatusResult>({
...
export declare namespace AttributableContractingStatusResult {
    ...
    interface OutOfNetwork extends serializers.encounters.v4.OutOfNetworkContractingStatusResult.Raw {
        contracting_status: "out_of_network";
    }

    interface InNetwork extends serializers.encounters.v4.InNetworkContractingStatusResult.Raw {

...
export const Error: core.serialization.Schema<
    serializers.contracts.v3.getContractProviders.Error.Raw,
...
> = core.serialization
    ...
    .transform<CandidApi.contracts.v3.getContractProviders.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "EntityNotFoundError":
                    return CandidApi.contracts.v3.getContractProviders.Error.entityNotFoundError(value.content);
                case "UnprocessableEntityError":
                    return CandidApi.contracts.v3.getContractProviders.Error.unprocessableEntityError(value.content);
            }
        },

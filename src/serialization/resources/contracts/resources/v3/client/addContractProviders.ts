...
export const Error: core.serialization.Schema<
    serializers.contracts.v3.addContractProviders.Error.Raw,
...
> = core.serialization
    ...
    .transform<CandidApi.contracts.v3.addContractProviders.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "EntityNotFoundError":
                    return CandidApi.contracts.v3.addContractProviders.Error.entityNotFoundError(value.content);
                case "UnprocessableEntityError":
                    return CandidApi.contracts.v3.addContractProviders.Error.unprocessableEntityError(value.content);
            }
        },

...
export const Error: core.serialization.Schema<
    serializers.preServiceRules.v1.createEncounterRun.Error.Raw,
...
> = core.serialization
    ...
    .transform<CandidApi.preServiceRules.v1.createEncounterRun.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "UnauthorizedError":
                    return CandidApi.preServiceRules.v1.createEncounterRun.Error.unauthorizedError(value.content);
                case "UnprocessableEntityError":
                    return CandidApi.preServiceRules.v1.createEncounterRun.Error.unprocessableEntityError(
                        value.content,
                    );
            }
        },

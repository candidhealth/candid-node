...
export const Error: core.serialization.Schema<
    serializers.nonInsurancePayerRefunds.v1.create.Error.Raw,
...
> = core.serialization
    ...
    .transform<CandidApi.nonInsurancePayerRefunds.v1.create.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "EntityNotFoundError":
                    return CandidApi.nonInsurancePayerRefunds.v1.create.Error.entityNotFoundError(value.content);
                case "UnprocessableEntityError":
                    return CandidApi.nonInsurancePayerRefunds.v1.create.Error.unprocessableEntityError(value.content);
            }
        },

...
export const Error: core.serialization.Schema<
    serializers.chargeCaptureBundles.v1.resubmit.Error.Raw,
...
> = core.serialization
    ...
    .transform<CandidApi.chargeCaptureBundles.v1.resubmit.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "NotImplementedError":
                    return CandidApi.chargeCaptureBundles.v1.resubmit.Error.notImplementedError(value.content);
            }
        },

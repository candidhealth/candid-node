...
export const InsuranceAdjudication: core.serialization.ObjectSchema<
    serializers.insuranceAdjudication.v1.InsuranceAdjudication.Raw,
...
> = core.serialization.object({
    insuranceAdjudicationId: core.serialization.property(
        ...
        core.serialization.lazy(
            async () => (await import("../../../../..")).insuranceAdjudication.v1.InsuranceAdjudicationId
        )
    ),
    ...
    claims: core.serialization.record(
        ...
        core.serialization.lazyObject(
            async () => (await import("../../../../..")).insuranceAdjudication.v1.ClaimAdjudication
        )
    ),
});

...
export const ClaimAdjudicationCreate: core.serialization.ObjectSchema<
    serializers.insuranceAdjudication.v1.ClaimAdjudicationCreate.Raw,
    CandidApi.insuranceAdjudication.v1.ClaimAdjudicationCreate
    ...
    serviceLines: core.serialization.property(
        ...
        core.serialization.record(
            ...
            core.serialization.lazyObject(
                async () => (await import("../../../../..")).insuranceAdjudication.v1.ServiceLineAdjudicationCreate
            )
        )
    ),
...
export declare namespace ClaimAdjudicationCreate {
    interface Raw {
        ...
        service_lines: Record<
            ...
            serializers.insuranceAdjudication.v1.ServiceLineAdjudicationCreate.Raw
        >;

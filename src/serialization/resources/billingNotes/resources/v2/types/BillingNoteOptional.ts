...
export const BillingNoteOptional: core.serialization.ObjectSchema<
    serializers.billingNotes.v2.BillingNoteOptional.Raw,
    CandidApi.billingNotes.v2.BillingNoteOptional
> = core.serialization
    .object({

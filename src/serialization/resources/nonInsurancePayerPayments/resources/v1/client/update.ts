...
export const Error: core.serialization.Schema<
    serializers.nonInsurancePayerPayments.v1.update.Error.Raw,
...
> = core.serialization
    ...
    .transform<CandidApi.nonInsurancePayerPayments.v1.update.Error>({
        transform: (value) => {
            switch (value.errorName) {
                case "EntityNotFoundError":
                    return CandidApi.nonInsurancePayerPayments.v1.update.Error.entityNotFoundError(value.content);
                case "UnprocessableEntityError":
                    return CandidApi.nonInsurancePayerPayments.v1.update.Error.unprocessableEntityError(value.content);
            }
        },

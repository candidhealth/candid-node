...
export const ClaimSubmissionRecordCreateOptional: core.serialization.ObjectSchema<
    serializers.claimSubmission.v1.ClaimSubmissionRecordCreateOptional.Raw,
    CandidApi.claimSubmission.v1.ClaimSubmissionRecordCreateOptional

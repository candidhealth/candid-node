...
export const InsuranceCard: core.serialization.ObjectSchema<serializers.InsuranceCard.Raw, CandidApi.InsuranceCard> =
    core.serialization
        .object({
            insuranceCardId: core.serialization.property(
                "insurance_card_id",
                core.serialization.lazy(async () => (await import("../../..")).InsuranceCardId)
            ),

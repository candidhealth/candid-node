...
export const Error = {
    entityNotFoundError: (
        ...
        return {
            ...
            _visit: function <_Result>(
                this: CandidApi.insurancePayments.v1.delete.Error.EntityNotFoundError,
    ...
    unauthorizedError: (
        ...
        return {
            ...
            errorName: "UnauthorizedError",
            _visit: function <_Result>(
                this: CandidApi.insurancePayments.v1.delete.Error.UnauthorizedError,
                visitor: CandidApi.insurancePayments.v1.delete.Error._Visitor<_Result>
            ) {
                return CandidApi.insurancePayments.v1.delete.Error._visit(this, visitor);
            },
    ...
    _unknown: (fetcherError: core.Fetcher.Error): CandidApi.insurancePayments.v1.delete.Error._Unknown => {
        return {
            ...
            _visit: function <_Result>(
                this: CandidApi.insurancePayments.v1.delete.Error._Unknown,
                visitor: CandidApi.insurancePayments.v1.delete.Error._Visitor<_Result>
            ) {
                return CandidApi.insurancePayments.v1.delete.Error._visit(this, visitor);
            },
    ...
    _visit: <_Result>(
        value: CandidApi.insurancePayments.v1.delete.Error,
        visitor: CandidApi.insurancePayments.v1.delete.Error._Visitor<_Result>
    ): _Result => {

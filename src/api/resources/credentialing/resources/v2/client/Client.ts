    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/provider-credentialing-span/v2/facility/${core.url.encodePathParam(serializers.credentialing.v2.FacilityCredentialingSpanId.jsonOrThrow(facilityCredentialingId))}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/provider-credentialing-span/v2/${core.url.encodePathParam(serializers.ProviderCredentialingSpanId.jsonOrThrow(providerCredentialingId))}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,

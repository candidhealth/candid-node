...
export const Error = {
    entityNotFoundError: (
        ...
        return {
            ...
            _visit: function <_Result>(
                this: CandidApi.patientRefunds.v1.create.Error.EntityNotFoundError,
    ...
    unauthorizedError: (
        ...
        return {
            ...
            errorName: "UnauthorizedError",
            _visit: function <_Result>(
                this: CandidApi.patientRefunds.v1.create.Error.UnauthorizedError,
                visitor: CandidApi.patientRefunds.v1.create.Error._Visitor<_Result>
            ) {
                return CandidApi.patientRefunds.v1.create.Error._visit(this, visitor);
            },
    ...
    unprocessableEntityError: (
        ...
        return {
            ...
            errorName: "UnprocessableEntityError",
            _visit: function <_Result>(
                this: CandidApi.patientRefunds.v1.create.Error.UnprocessableEntityError,
                visitor: CandidApi.patientRefunds.v1.create.Error._Visitor<_Result>
            ) {
                return CandidApi.patientRefunds.v1.create.Error._visit(this, visitor);
            },
    ...
    _unknown: (fetcherError: core.Fetcher.Error): CandidApi.patientRefunds.v1.create.Error._Unknown => {
        return {
            ...
            _visit: function <_Result>(
                this: CandidApi.patientRefunds.v1.create.Error._Unknown,
                visitor: CandidApi.patientRefunds.v1.create.Error._Visitor<_Result>
            ) {
                return CandidApi.patientRefunds.v1.create.Error._visit(this, visitor);
            },
    ...
    _visit: <_Result>(
        value: CandidApi.patientRefunds.v1.create.Error,
        visitor: CandidApi.patientRefunds.v1.create.Error._Visitor<_Result>
    ): _Result => {

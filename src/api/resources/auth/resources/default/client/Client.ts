...
export declare namespace DefaultClient {
...
export class DefaultClient {
    protected readonly _options: NormalizedClientOptions<DefaultClient.Options>;

    constructor(options: DefaultClient.Options) {

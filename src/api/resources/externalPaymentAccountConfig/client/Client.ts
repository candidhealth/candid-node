...
export class ExternalPaymentAccountConfig {
    protected readonly _options: ExternalPaymentAccountConfig.Options;
    protected _v1: V1 | undefined;

    constructor(_options: ExternalPaymentAccountConfig.Options = {}) {

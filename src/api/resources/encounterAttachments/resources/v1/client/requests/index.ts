...
export type { CreateExternalAttachmentRequest } from "./CreateExternalAttachmentRequest";
export type { DeleteAttachmentRequest } from "./DeleteAttachmentRequest";
export type { DeleteExternalAttachmentRequest } from "./DeleteExternalAttachmentRequest";

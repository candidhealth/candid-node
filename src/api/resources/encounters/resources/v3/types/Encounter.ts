...
export interface Encounter extends CandidApi.encounters.v3.EncounterBase {
    ...
    clinicalNotes: CandidApi.encounters.v3.ClinicalNoteCategory[];
    /**
    ...
    tags: CandidApi.Tag[];
    codingAttribution?: CandidApi.encounters.v3.CodingAttributionType;
}

...
export interface EncounterBase {
     ...
     *
     */
    endDateOfService?: CandidApi.Date;
     ...
     */
    doNotBill?: boolean;
    existingMedications?: CandidApi.encounters.v3.Medication[];
    vitals?: CandidApi.encounters.v3.Vitals;
    interventions?: CandidApi.encounters.v3.Intervention[];
     ...
     *
     */
    synchronicity?: CandidApi.encounters.v3.SynchronicityType;
}

...
export const Error = {
    ...
    ): CandidApi.contracts.v3.get.Error.EntityNotFoundError => {
        return {
            content: value,
            errorName: "EntityNotFoundError",
            _visit: function <_Result>(
                this: CandidApi.contracts.v3.get.Error.EntityNotFoundError,
                visitor: CandidApi.contracts.v3.get.Error._Visitor<_Result>,
            ) {
    ...
    _unknown: (fetcherError: core.Fetcher.Error): CandidApi.contracts.v3.get.Error._Unknown => {
        return {
            errorName: undefined,
            content: fetcherError,
            _visit: function <_Result>(
                this: CandidApi.contracts.v3.get.Error._Unknown,
                visitor: CandidApi.contracts.v3.get.Error._Visitor<_Result>,
            ) {
                return CandidApi.contracts.v3.get.Error._visit(this, visitor);
            },
    ...
    _visit: <_Result>(
        value: CandidApi.contracts.v3.get.Error,
        visitor: CandidApi.contracts.v3.get.Error._Visitor<_Result>,
    ): _Result => {

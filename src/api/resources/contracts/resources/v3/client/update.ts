...
export type Error =
    | CandidApi.contracts.v3.update.Error.UnprocessableEntityError
    | CandidApi.contracts.v3.update.Error.ContractInvalidExpirationDateHttpError
    | CandidApi.contracts.v3.update.Error._Unknown;
...
export const Error = {
    unprocessableEntityError: (
        ...
        return {
            ...
            _visit: function <_Result>(
                this: CandidApi.contracts.v3.update.Error.UnprocessableEntityError,
                visitor: CandidApi.contracts.v3.update.Error._Visitor<_Result>,
            ) {
    ...
    contractInvalidExpirationDateHttpError: (
        ...
        return {
            ...
            errorName: "ContractInvalidExpirationDateHttpError",
            _visit: function <_Result>(
                this: CandidApi.contracts.v3.update.Error.ContractInvalidExpirationDateHttpError,
                visitor: CandidApi.contracts.v3.update.Error._Visitor<_Result>,
            ) {
                return CandidApi.contracts.v3.update.Error._visit(this, visitor);
            },
    ...
    _unknown: (fetcherError: core.Fetcher.Error): CandidApi.contracts.v3.update.Error._Unknown => {
        return {
            errorName: undefined,
            content: fetcherError,
            _visit: function <_Result>(
                this: CandidApi.contracts.v3.update.Error._Unknown,
                visitor: CandidApi.contracts.v3.update.Error._Visitor<_Result>,
            ) {
                return CandidApi.contracts.v3.update.Error._visit(this, visitor);
            },
    ...
    _visit: <_Result>(
        value: CandidApi.contracts.v3.update.Error,
        visitor: CandidApi.contracts.v3.update.Error._Visitor<_Result>,
    ): _Result => {

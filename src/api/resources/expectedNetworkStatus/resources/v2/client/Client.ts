    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/expected-network-status/v2/compute/${core.url.encodePathParam(serializers.organizationProviders.v2.OrganizationProviderId.jsonOrThrow(renderingProviderId))}`,
            ),
            method: "POST",
            headers: _headers,

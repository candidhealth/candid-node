    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/encounter-providers/v2/${core.url.encodePathParam(serializers.EncounterId.jsonOrThrow(encounterId))}`,
            ),
            method: "PATCH",
            headers: _headers,
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/encounter-providers/v2/${core.url.encodePathParam(serializers.EncounterId.jsonOrThrow(encounterId))}/initial-referring-provider`,
            ),
            method: "PATCH",
            headers: _headers,
            contentType: "application/json",
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/encounter-providers/v2/${core.url.encodePathParam(serializers.EncounterId.jsonOrThrow(encounterId))}/supervising-provider`,
            ),
            method: "PATCH",
            headers: _headers,
            contentType: "application/json",
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/encounter-providers/v2/${core.url.encodePathParam(serializers.ServiceLineId.jsonOrThrow(serviceLineId))}/ordering-provider`,
            ),
            method: "PATCH",
            headers: _headers,
            contentType: "application/json",
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/encounter-providers/v2/${core.url.encodePathParam(serializers.EncounterId.jsonOrThrow(encounterId))}/create-referring-provider`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/encounter-providers/v2/${core.url.encodePathParam(serializers.EncounterId.jsonOrThrow(encounterId))}/create-initial-referring-provider`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/encounter-providers/v2/${core.url.encodePathParam(serializers.EncounterId.jsonOrThrow(encounterId))}/create-supervising-provider`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/encounter-providers/v2/${core.url.encodePathParam(serializers.ServiceLineId.jsonOrThrow(serviceLineId))}/create-ordering-provider`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/encounter-providers/v2/${core.url.encodePathParam(serializers.EncounterId.jsonOrThrow(encounterId))}/referring-provider`,
            ),
            method: "DELETE",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,

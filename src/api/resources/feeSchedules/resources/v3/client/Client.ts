    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/fee-schedules/v3/service-line/${core.url.encodePathParam(serializers.ServiceLineId.jsonOrThrow(serviceLineId))}/match`,
            ),
            method: "GET",
            headers: _headers,
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/fee-schedules/v3/service-line/${core.url.encodePathParam(serializers.ServiceLineId.jsonOrThrow(serviceLineId))}/match/${core.url.encodePathParam(serializers.RateId.jsonOrThrow(rateId))}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/fee-schedules/v3/${core.url.encodePathParam(serializers.RateId.jsonOrThrow(rateId))}/history`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
    ...
    private async __deleteRate(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/fee-schedules/v3/${core.url.encodePathParam(serializers.RateId.jsonOrThrow(rateId))}/${core.url.encodePathParam(version)}`,
            ),
            method: "DELETE",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/fee-schedules/v3/payer-threshold/${core.url.encodePathParam(serializers.payers.v3.PayerUuid.jsonOrThrow(payerUuid))}`,
            ),
            method: "PUT",
            headers: _headers,
            contentType: "application/json",

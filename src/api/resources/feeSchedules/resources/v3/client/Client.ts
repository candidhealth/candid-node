...
export class V3Client {
    ...
    > {
        return core.HttpResponsePromise.fromPromise(this.__getMatch(service_line_id, requestOptions));
    }
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/fee-schedules/v3/service-line/${core.url.encodePathParam(serializers.ServiceLineId.jsonOrThrow(service_line_id))}/match`,
            ),
            method: "GET",
            headers: _headers,
     ...
     *
     * @param {CandidApi.ServiceLineId} service_line_id
     * @param {CandidApi.RateId} rate_id
     * @param {V3Client.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    > {
        return core.HttpResponsePromise.fromPromise(this.__testMatch(service_line_id, rate_id, requestOptions));
    }
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/fee-schedules/v3/service-line/${core.url.encodePathParam(serializers.ServiceLineId.jsonOrThrow(service_line_id))}/match/${core.url.encodePathParam(serializers.RateId.jsonOrThrow(rate_id))}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
    ...
    > {
        ...
        const _queryParams: Record<string, unknown> = {
            ...
            limit,
            active_date: activeDate != null ? activeDate : undefined,
            payer_uuid: payerUuid,
            organization_billing_provider_id: organizationBillingProviderId,
            states: Array.isArray(states)
                ...
                : states != null
                  ...
                  : undefined,
            zip_codes: zipCodes,
            license_types: Array.isArray(licenseTypes)
                ...
                : licenseTypes != null
                  ? serializers.organizationProviders.v2.LicenseType.jsonOrThrow(licenseTypes, {
                        unrecognizedObjectKeys: "strip",
                    })
                  : undefined,
            facility_type_codes: Array.isArray(facilityTypeCodes)
                ? facilityTypeCodes.map((item) =>
                      serializers.FacilityTypeCode.jsonOrThrow(item, { unrecognizedObjectKeys: "strip" }),
                  )
                : facilityTypeCodes != null
                  ? serializers.FacilityTypeCode.jsonOrThrow(facilityTypeCodes, { unrecognizedObjectKeys: "strip" })
                  : undefined,
            network_types: Array.isArray(networkTypes)
                ? networkTypes.map((item) =>
                      serializers.NetworkType.jsonOrThrow(item, { unrecognizedObjectKeys: "strip" }),
                  )
                : networkTypes != null
                  ? serializers.NetworkType.jsonOrThrow(networkTypes, { unrecognizedObjectKeys: "strip" })
                  : undefined,
            payer_plan_group_ids: payerPlanGroupIds,
            cpt_code: cptCode,
            modifiers: Array.isArray(modifiers)
                ...
                : modifiers != null
                  ? serializers.ProcedureModifier.jsonOrThrow(modifiers, { unrecognizedObjectKeys: "strip" })
                  : undefined,
        };
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
    ...
    > {
        ...
        const _queryParams: Record<string, unknown> = {
            page_token: pageToken,
            limit,
            pivot_dimension: serializers.feeSchedules.v3.DimensionName.jsonOrThrow(pivotDimension, {
                unrecognizedObjectKeys: "strip",
            }),
            payer_uuid: payerUuid,
            organization_billing_provider_id: organizationBillingProviderId,
    ...
    > {
        return core.HttpResponsePromise.fromPromise(this.__getRateHistory(rate_id, requestOptions));
    }
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/fee-schedules/v3/${core.url.encodePathParam(serializers.RateId.jsonOrThrow(rate_id))}/history`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
    ...
    public deleteRate(
        ...
        return core.HttpResponsePromise.fromPromise(this.__deleteRate(rate_id, version, requestOptions));
    }
    ...
    private async __deleteRate(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/fee-schedules/v3/${core.url.encodePathParam(serializers.RateId.jsonOrThrow(rate_id))}/${core.url.encodePathParam(version)}`,
            ),
            method: "DELETE",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
    ...
    > {
        return core.HttpResponsePromise.fromPromise(this.__setPayerThreshold(payer_uuid, request, requestOptions));
    }
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/fee-schedules/v3/payer-threshold/${core.url.encodePathParam(serializers.payers.v3.PayerUuid.jsonOrThrow(payer_uuid))}`,
            ),
            method: "PUT",
            headers: _headers,
            contentType: "application/json",

...
export function FilterQueryString(value: string): CandidApi.preEncounter.FilterQueryString {
    return value as unknown as CandidApi.preEncounter.FilterQueryString;
}

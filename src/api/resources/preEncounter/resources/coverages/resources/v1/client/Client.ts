...
export class V1Client {
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/coverages/v1/${core.url.encodePathParam(serializers.preEncounter.CoverageId.jsonOrThrow(id))}/${core.url.encodePathParam(version)}`,
            ),
            method: "PUT",
            headers: _headers,
            contentType: "application/json",
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/coverages/v1/${core.url.encodePathParam(serializers.preEncounter.CoverageId.jsonOrThrow(id))}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
    ...
    > {
        ...
        const _queryParams: Record<string, unknown> = {
            ...
            non_auto_updated_coverages_only: nonAutoUpdatedCoveragesOnly,
            sort_direction:
                sortDirection != null
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/coverages/v1/${core.url.encodePathParam(serializers.preEncounter.CoverageId.jsonOrThrow(id))}/history`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
     ...
     *
     * @param {CandidApi.preEncounter.PayerPlanGroupId} ppg_id
    ...
    public batchUpdatePpg(
        ppg_id: CandidApi.preEncounter.PayerPlanGroupId,
        ...
        return core.HttpResponsePromise.fromPromise(this.__batchUpdatePpg(ppg_id, request, requestOptions));
    }
    ...
    private async __batchUpdatePpg(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/coverages/v1/batch-update-ppg/${core.url.encodePathParam(serializers.preEncounter.PayerPlanGroupId.jsonOrThrow(ppg_id))}`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/coverages/v1/${core.url.encodePathParam(serializers.preEncounter.CoverageId.jsonOrThrow(id))}/eligibility`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
    ...
    public getEligibility(
        ...
        >
    > {
        return core.HttpResponsePromise.fromPromise(this.__getEligibility(id, check_id, requestOptions));
    }
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/coverages/v1/${core.url.encodePathParam(serializers.preEncounter.CoverageId.jsonOrThrow(id))}/eligibility/${core.url.encodePathParam(check_id)}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
     ...
     *
     * @param {CandidApi.preEncounter.coverages.v1.CheckInsuranceDiscoveryRequest} request
     * @param {V1Client.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *     })
     */
    public checkInsuranceDiscovery(
        ...
        core.APIResponse<
            ...
            CandidApi.preEncounter.coverages.v1.checkInsuranceDiscovery.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(this.__checkInsuranceDiscovery(request, requestOptions));
    }

    private async __checkInsuranceDiscovery(
        request: CandidApi.preEncounter.coverages.v1.CheckInsuranceDiscoveryRequest,
        requestOptions?: V1Client.RequestOptions,
    ): Promise<
        core.WithRawResponse<
    ...
    > {
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: requestOptions?.queryParams,
            requestType: "json",
            body: serializers.preEncounter.coverages.v1.CheckInsuranceDiscoveryRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
            }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.preEncounter.eligibilityChecks.v1.InsuranceDiscoveryCheckMetadata.parseOrThrow(
                        _response.body,
                        {
                            unrecognizedObjectKeys: "passthrough",
                            allowUnrecognizedUnionMembers: true,
        ...
        return {
            data: {
                ok: false,
                error: CandidApi.preEncounter.coverages.v1.checkInsuranceDiscovery.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };
     ...
     */
    public getInsuranceDiscovery(
        check_id: string,
        requestOptions?: V1Client.RequestOptions,
    ): core.HttpResponsePromise<
        core.APIResponse<
            CandidApi.preEncounter.eligibilityChecks.v1.AsyncInsuranceDiscoveryCheckResult,
            CandidApi.preEncounter.coverages.v1.getInsuranceDiscovery.Error
        >
    > {
        return core.HttpResponsePromise.fromPromise(this.__getInsuranceDiscovery(check_id, requestOptions));
    }

    private async __getInsuranceDiscovery(
        check_id: string,
        requestOptions?: V1Client.RequestOptions,
    ): Promise<
        core.WithRawResponse<
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/coverages/v1/insurance-discovery/${core.url.encodePathParam(check_id)}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        if (_response.ok) {
            return {
                data: {
                    ok: true,
                    body: serializers.preEncounter.eligibilityChecks.v1.AsyncInsuranceDiscoveryCheckResult.parseOrThrow(
                        _response.body,
                        {
                            unrecognizedObjectKeys: "passthrough",
                            allowUnrecognizedUnionMembers: true,
        ...
        return {
            data: {
                ok: false,
                error: CandidApi.preEncounter.coverages.v1.getInsuranceDiscovery.Error._unknown(_response.error),
                rawResponse: _response.rawResponse,
            },
            rawResponse: _response.rawResponse,
        };

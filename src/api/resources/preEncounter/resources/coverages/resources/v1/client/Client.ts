    ...
    private async __batchUpdatePpg(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/coverages/v1/batch-update-ppg/${core.url.encodePathParam(serializers.preEncounter.PayerPlanGroupId.jsonOrThrow(ppgId))}`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/coverages/v1/${core.url.encodePathParam(serializers.preEncounter.CoverageId.jsonOrThrow(id))}/eligibility/${core.url.encodePathParam(checkId)}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,

...
export type Error =
    | CandidApi.preEncounter.patients.v1.reactivate.Error.NotFoundError
    | CandidApi.preEncounter.patients.v1.reactivate.Error.VersionConflictError
    | CandidApi.preEncounter.patients.v1.reactivate.Error._Unknown;
...
export const Error = {
    notFoundError: (
        ...
        return {
            ...
            _visit: function <_Result>(
                this: CandidApi.preEncounter.patients.v1.reactivate.Error.NotFoundError,
                visitor: CandidApi.preEncounter.patients.v1.reactivate.Error._Visitor<_Result>,
            ) {
    ...
    versionConflictError: (
        ...
        return {
            ...
            errorName: "VersionConflictError",
            _visit: function <_Result>(
                this: CandidApi.preEncounter.patients.v1.reactivate.Error.VersionConflictError,
                visitor: CandidApi.preEncounter.patients.v1.reactivate.Error._Visitor<_Result>,
            ) {
                return CandidApi.preEncounter.patients.v1.reactivate.Error._visit(this, visitor);
            },
    ...
    _unknown: (fetcherError: core.Fetcher.Error): CandidApi.preEncounter.patients.v1.reactivate.Error._Unknown => {
        return {
            errorName: undefined,
            content: fetcherError,
            _visit: function <_Result>(
                this: CandidApi.preEncounter.patients.v1.reactivate.Error._Unknown,
                visitor: CandidApi.preEncounter.patients.v1.reactivate.Error._Visitor<_Result>,
            ) {
                return CandidApi.preEncounter.patients.v1.reactivate.Error._visit(this, visitor);
            },
    ...
    _visit: <_Result>(
        value: CandidApi.preEncounter.patients.v1.reactivate.Error,
        visitor: CandidApi.preEncounter.patients.v1.reactivate.Error._Visitor<_Result>,
    ): _Result => {

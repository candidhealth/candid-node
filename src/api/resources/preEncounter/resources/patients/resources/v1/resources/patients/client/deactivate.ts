...
export type Error =
    | CandidApi.preEncounter.patients.v1.patients.deactivate.Error.NotFoundError
    | CandidApi.preEncounter.patients.v1.patients.deactivate.Error.VersionConflictError
    | CandidApi.preEncounter.patients.v1.patients.deactivate.Error._Unknown;
...
export declare namespace Error {
    ...
    interface _Utils {
        _visit: <_Result>(
            visitor: CandidApi.preEncounter.patients.v1.patients.deactivate.Error._Visitor<_Result>
        ) => _Result;
    }
...
export const Error = {
    notFoundError: (
        ...
        return {
            ...
            _visit: function <_Result>(
                this: CandidApi.preEncounter.patients.v1.patients.deactivate.Error.NotFoundError,
                visitor: CandidApi.preEncounter.patients.v1.patients.deactivate.Error._Visitor<_Result>
            ) {
    ...
    versionConflictError: (
        ...
        return {
            ...
            errorName: "VersionConflictError",
            _visit: function <_Result>(
                this: CandidApi.preEncounter.patients.v1.patients.deactivate.Error.VersionConflictError,
                visitor: CandidApi.preEncounter.patients.v1.patients.deactivate.Error._Visitor<_Result>
            ) {
                return CandidApi.preEncounter.patients.v1.patients.deactivate.Error._visit(this, visitor);
            },
    ...
    _unknown: (
        ...
        return {
            ...
            _visit: function <_Result>(
                this: CandidApi.preEncounter.patients.v1.patients.deactivate.Error._Unknown,
                visitor: CandidApi.preEncounter.patients.v1.patients.deactivate.Error._Visitor<_Result>
            ) {
                return CandidApi.preEncounter.patients.v1.patients.deactivate.Error._visit(this, visitor);
            },
    ...
    _visit: <_Result>(
        value: CandidApi.preEncounter.patients.v1.patients.deactivate.Error,
        visitor: CandidApi.preEncounter.patients.v1.patients.deactivate.Error._Visitor<_Result>
    ): _Result => {

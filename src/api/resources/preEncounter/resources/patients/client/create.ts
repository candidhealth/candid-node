...
export type Error =
    | CandidApi.preEncounter.patients.create.Error.VersionConflictError
    | CandidApi.preEncounter.patients.create.Error._Unknown;
...
export const Error = {
    versionConflictError: (
        ...
        return {
            ...
            _visit: function <_Result>(
                this: CandidApi.preEncounter.patients.create.Error.VersionConflictError,
                visitor: CandidApi.preEncounter.patients.create.Error._Visitor<_Result>
            ) {
    ...
    _unknown: (fetcherError: core.Fetcher.Error): CandidApi.preEncounter.patients.create.Error._Unknown => {
        return {
            errorName: undefined,
            content: fetcherError,
            _visit: function <_Result>(
                this: CandidApi.preEncounter.patients.create.Error._Unknown,
                visitor: CandidApi.preEncounter.patients.create.Error._Visitor<_Result>
            ) {
                return CandidApi.preEncounter.patients.create.Error._visit(this, visitor);
            },
    ...
    _visit: <_Result>(
        value: CandidApi.preEncounter.patients.create.Error,
        visitor: CandidApi.preEncounter.patients.create.Error._Visitor<_Result>
    ): _Result => {

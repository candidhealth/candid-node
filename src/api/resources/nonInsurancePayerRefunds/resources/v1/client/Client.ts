...
export class V1Client {
    ...
    > {
        ...
        const _queryParams: Record<string, unknown> = {
            ...
            sort:
                sort != null
                    ? serializers.nonInsurancePayerRefunds.v1.NonInsurancePayerRefundSortField.jsonOrThrow(sort, {
     ...
     *
     * @param {CandidApi.nonInsurancePayerRefunds.v1.NonInsurancePayerRefundId} non_insurance_payer_refund_id
     * @param {V1Client.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     */
    public get(
        non_insurance_payer_refund_id: CandidApi.nonInsurancePayerRefunds.v1.NonInsurancePayerRefundId,
        requestOptions?: V1Client.RequestOptions,
    ): core.HttpResponsePromise<
        core.APIResponse<
        ...
        >
    > {
        return core.HttpResponsePromise.fromPromise(this.__get(non_insurance_payer_refund_id, requestOptions));
    }
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/non-insurance-payer-refunds/v1/${core.url.encodePathParam(serializers.nonInsurancePayerRefunds.v1.NonInsurancePayerRefundId.jsonOrThrow(non_insurance_payer_refund_id))}`,
            ),
            method: "GET",
            headers: _headers,
    ...
    > {
        return core.HttpResponsePromise.fromPromise(
            this.__update(non_insurance_payer_refund_id, request, requestOptions),
        );
    }
    ...
    public delete(
        ...
        return core.HttpResponsePromise.fromPromise(this.__delete(non_insurance_payer_refund_id, requestOptions));
    }

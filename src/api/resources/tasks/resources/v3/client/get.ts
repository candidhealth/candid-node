...
export const Error = {
    ...
    unauthorizedError: (value: CandidApi.UnauthorizedErrorMessage): CandidApi.tasks.v3.get.Error.UnauthorizedError => {
        return {
            content: value,
            errorName: "UnauthorizedError",
            _visit: function <_Result>(
    ...
    _unknown: (fetcherError: core.Fetcher.Error): CandidApi.tasks.v3.get.Error._Unknown => {
        return {
            errorName: undefined,

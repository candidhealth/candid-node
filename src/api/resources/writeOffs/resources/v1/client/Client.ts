    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/write-offs/v1/${core.url.encodePathParam(serializers.writeOffs.v1.WriteOffId.jsonOrThrow(writeOffId))}`,
            ),
            method: "GET",
            headers: _headers,
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/write-offs/v1/${core.url.encodePathParam(serializers.writeOffs.v1.WriteOffId.jsonOrThrow(writeOffId))}/revert`,
            ),
            method: "POST",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/write-offs/v1/${core.url.encodePathParam(serializers.AdjustmentId.jsonOrThrow(adjustmentId))}/revert`,
            ),
            method: "POST",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
    ...
    > {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/api/write-offs/v1/${core.url.encodePathParam(serializers.AdjustmentId.jsonOrThrow(adjustmentId))}/revert-era-originated`,
            ),
            method: "POST",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,

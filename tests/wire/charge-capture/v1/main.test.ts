...
describe("V1Client", () => {
                ...
                chargeCaptureData: {
                    ...
                    subscriberPrimary: {
                        insuranceCard: {
                            ...
                            payerPlanGroupName: "payer_plan_group_name",
    ...
    test("findByMetadata", async () => {
        ...
        server
            .mockEndpoint()
            .post("/api/charge_captures/v1/find-by-metadata")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
        ...
        const response = await client.chargeCapture.v1.findByMetadata({
            metadata: [
                {
                    schemaId: CandidApi.SchemaId("d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32"),
                    content: {

...
describe("V1Client", () => {
    test("get", async () => {
        ...
        const rawResponseBody = {
            ...
            created_encounter_id: "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32",
            status: "not-started",
        ...
        const response = await client.chargeCaptureBundles.v1.get(
            CandidApi.ChargeCaptureClaimCreationId("d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32"),
        );
        expect(response).toEqual({
            body: {
                id: CandidApi.ChargeCaptureClaimCreationId("d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32"),
                createdEncounterId: CandidApi.EncounterId("d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32"),
                status: "not-started",
                characteristics: {
                    characteristics: {
                        key: "value",
    ...
    test("getSummary", async () => {
        ...
        const response = await client.chargeCaptureBundles.v1.getSummary();
        expect(response).toEqual({
            body: {
                chargeCaptureChargesNotLinkedToClaimsCount: 1,
                chargeCaptureClaimCreationsNotStartedCount: 1,
                chargeCaptureHeldClaimCreationsCount: 1,
                chargeCaptureClaimCreationsInErrorCount: 1,
                chargeCaptureUnresolvedChangeCount: 1,
            },
            ok: true,
            headers: expect.any(Object),
            rawResponse: expect.any(Object),
    ...
    test("resolveChargeCreationError", async () => {
        const server = mockServerPool.createServer();
        mockOAuthScheme(server);
        ...
        server
            .mockEndpoint()
            .patch("/api/charge_capture_claim_creation/v1/error/d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
            .build();

        const response = await client.chargeCaptureBundles.v1.resolveChargeCreationError(
            "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32",
        );
        expect(response).toEqual({
            body: undefined,
    ...
    test("getAll", async () => {
        ...
        const response = await client.chargeCaptureBundles.v1.getAll();
        expect(response).toEqual({
            body: {
                items: [
                    {

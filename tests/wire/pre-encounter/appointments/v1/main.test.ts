...
describe("V1Client", () => {
    test("create", async () => {
        ...
        const rawResponseBody = {
            ...
            appointment_reason_detail: {
                diagnosis_codes: ["diagnosis_codes", "diagnosis_codes"],
                procedure_codes: ["procedure_codes", "procedure_codes"],
            },
        ...
        expect(response).toEqual({
            body: {
                ...
                checkedOutTimestamp: new Date("2024-01-15T09:30:00.000Z"),
                appointmentReasonDetail: {
                    diagnosisCodes: [
                        CandidApi.preEncounter.appointments.v1.DiagnosisCode("diagnosis_codes"),
                        CandidApi.preEncounter.appointments.v1.DiagnosisCode("diagnosis_codes"),
                    ],
                    procedureCodes: [
                        CandidApi.preEncounter.appointments.v1.ProcedureCode("procedure_codes"),
                        CandidApi.preEncounter.appointments.v1.ProcedureCode("procedure_codes"),
                    ],
                },
                medicalNecessityVerified: true,
                priorAuthorizationStatus: "NOT_REQUIRED",
                notes: "notes",
    ...
    test("get_counts", async () => {
        ...
        const rawResponseBody = { not_ready_reason_counts: { INACTIVE_PRIMARY: 1 } };
        ...
        const response = await client.preEncounter.appointments.v1.getCounts();
        expect(response).toEqual({
            body: {
                notReadyReasonCounts: {
                    INACTIVE_PRIMARY: 1,
                },
            },
            ok: true,
